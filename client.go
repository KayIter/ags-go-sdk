...
func NewClient(opts ...ClientOption) (*Client, error) {
	...
	if c.control == nil {
		c.control = newTencentControlPlane(c.region, c.credential, c.controlEndpoint, c.httpClient, c.timeout)
	}
	if c.monitor == nil {
		c.monitor = newTencentMonitorWithConfig(c.region, c.credential, c.monitorEndpoint, c.httpClient, c.timeout)
	}
	out := &Client{cfg: c}
